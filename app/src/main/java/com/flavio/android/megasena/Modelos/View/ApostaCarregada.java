...
import com.flavio.android.megasena.Modelos.Dao.DaoApostaSequencia;
...
public class ApostaCarregada extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.conteudo = findViewById ( R.id.txtApostaCarregadaConteudo );
